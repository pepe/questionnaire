...
Feature: Create thank-you page
  ...
  Scenario: Note and contact information
    ...
    And I should see 'V případě, že byste rádi jakýmkoliv způsobem okomentovali dotazník a tím se podíleli na jeho budoucím zkvalitnění, máte prostor níže.'
    And I should see 'Pokud budete mít zájem o zaslání výsledků tohoto průzkumu, vypište prosím níže Vaši emailovou adresu. Výsledky Vám budou zaslány po závěrečném zpracování dat. Vaše emailová adresa nebude použita pro žádné jiné účely.'
    When I fill in 'je super!' for 'poznámka'
